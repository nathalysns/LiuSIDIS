...
int main(int argc, char * argv[]){
  ...
  if (argc < 2){
    cout << "./analysis_deuteron <opt>" << endl;
  ...
  if (opt == 7){
    //MakeRateDistributionPlots(11.0, "pi+", "ProtonResults/ratedistri_pip_test.root");
    MakeRateDistributionPlots(11.0, "pi-", "ProtonResults/ratedistri_pim_test.root");
  }
  
  if (opt == 8){
    Rfactor0 = 0.4;
    MakeRateDistributionPlots(11.0, "pi+", "ProtonResults/ratedistri_11p_test.root");
  }
