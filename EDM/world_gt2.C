...
int main(int argc, char * argv[]){
  ...
  TCanvas * c0 = new TCanvas("c0", "", 1200, 750);
  ...
  if (opt == 1){
    ...
    h0->GetYaxis()->SetRangeUser(-35, -4.5);
    ...
    double lwidth = 1.;
    TLatex * t0;
    t0 = new TLatex(0.65, -11.5, "#font[32]{g_{T}^{u}}");
    t0->SetTextSize(0.04);
    t0->DrawClone("same");
    t0 = new TLatex(-0.2, -11.5, "#font[32]{g_{T}^{d}}");
    t0->SetTextSize(0.04);
    t0->DrawClone("same");
    ...
    TLegend * leg = new TLegend(0.12, 0.78, 0.78, 0.88);
    leg->SetNColumns(3);
  ...
  if (opt == 2){
    ...
    h0->GetYaxis()->SetRangeUser(-28, -6.0);
    ...
    double lwidth = 1.;
    TLatex * t0;
    t0 = new TLatex(0.75, -11.0, "#font[32]{g_{T}^{(1)} = g_{T}^{u} - g_{T}^{d}}");
    t0->SetTextAlign(22);
    t0->SetTextSize(0.04);
    t0->DrawClone("same");
    ...
    TLegend * leg = new TLegend(0.12, 0.78, 0.88, 0.88);
    leg->SetNColumns(2);
    leg->SetBorderSize(0);
