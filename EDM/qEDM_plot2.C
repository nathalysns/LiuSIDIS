...
int main(const int argc, const char * argv[]){
  ...
  if (opt == 1){//pEDM plot
    ...
    l0->SetBorderSize(0);
    l0->AddEntry(g1, "#font[22]{current g_{T}  +  current d_{p}}", "p");
    l0->AddEntry(g2, "#font[22]{future   g_{T}  +  current d_{p}}", "p");
    l0->AddEntry(g3, "#font[22]{future   g_{T}  +  future   d_{p}}", "p");
  ...
  if (opt == 2){//nEDM plot
    ...
    TLegend * l0 = new TLegend(0.16, 0.72, 0.50, 0.88);
    l0->SetBorderSize(0);
    l0->AddEntry(g1, "#font[22]{current g_{T}  +  current d_{n}}", "p");
    l0->AddEntry(g2, "#font[22]{future   g_{T}  +  current d_{n}}", "p");
    l0->AddEntry(g3, "#font[22]{future   g_{T}  +  future   d_{n}}", "p");
