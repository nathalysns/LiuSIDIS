...
int main(int argc, char * argv[]){
  ...
  for (Long64_t i = 0; i < Nsim; i++){
    ...
    if (weight > 0){
      ...
      if ((Q2 < 1.7 && lp.Theta() > 10.0/180.0 * M_PI) || (lp.Theta() < 10.0/180.0 * M_PI && lp.P() < 5.0)){
  ...
  c1->Print("Prescale10(Q2<1.7,l<5)1D.pdf");
  ...
  c2->Print("Prescale10(Q2<1.7,l<5)2D.pdf");
  ...
  c3->Print("Distribution(Q2<1.7,l<5)2D.pdf");
