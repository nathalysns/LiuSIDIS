...
int main(int argc, char * argv[]){
  ...
  TH2D * txz = new TH2D("txz", "", 35, 0.0, 0.7, 25, 0.25, 0.75);
  TH2D * sxz = new TH2D("sxz", "", 35, 0.0, 0.7, 25, 0.25, 0.75);
  TH2D * rxz = new TH2D("rxz", "", 35, 0.0, 0.7, 25, 0.25, 0.75);
  ...
  TH2D * tzPt = new TH2D("tzPt", "", 25, 0.25, 0.75, 36, 0.0, 1.8);
  TH2D * szPt = new TH2D("szPt", "", 25, 0.25, 0.75, 36, 0.0, 1.8);
  TH2D * rzPt = new TH2D("rzPt", "", 25, 0.25, 0.75, 36, 0.0, 1.8);
  ...
  c1->Print("Prescale10(Q2<1.7)1D.pdf");
  ...
  c2->Print("Prescale10(Q2<1.7)2D.pdf");
  ...
  c3->Print("Distribution(Q2<1.7)2D.pdf");
